...
class ForumThreadsControllerTest < ActionController::TestCase
  ...
  test "should create forum_thread" do
    assert_difference('ForumThread.count') do
      post :create, forum_thread: { anon_allowed: @forum_thread.anon_allowed, body: @forum_thread.body, pseudo_allowed: @forum_thread.pseudo_allowed, real_allowed: @forum_thread.real_allowed, title: @forum_thread.title, user_id: @forum_thread.user_id }
    end
  ...
  test "should update forum_thread" do
    patch :update, id: @forum_thread, forum_thread: { anon_allowed: @forum_thread.anon_allowed, body: @forum_thread.body, pseudo_allowed: @forum_thread.pseudo_allowed, real_allowed: @forum_thread.real_allowed, title: @forum_thread.title, user_id: @forum_thread.user_id }
    assert_redirected_to forum_thread_path(assigns(:forum_thread))
  end
